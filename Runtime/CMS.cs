    ...
    public static class CMS
    {
        ...
        private static BaseModel InstantiateByType(string templateName)
        {
            switch (templateName)
            {
                ...
                case "LiveOps.Tasks.BaseTask": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.BaseTask();
                case "LiveOps.Tasks.TaskCustom": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.TaskCustom();
                case "LiveOps.Tasks.TaskFieldNumber": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.TaskFieldNumber();
                case "LiveOps.Tasks.TaskCondition": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.TaskCondition();
                case "LiveOps.Tasks.TaskItem": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.TaskItem();
                case "LiveOps.Tasks.TaskCompleteLevels": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.TaskCompleteLevels();
                case "LiveOps.Tasks.TaskCompleteLevelsStreak": return OnTypeRequested?.Invoke(templateName) ?? new Balancy.Models.LiveOps.Tasks.TaskCompleteLevelsStreak();
