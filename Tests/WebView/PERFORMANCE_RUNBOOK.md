...
```csharp
// По умолчанию: показ сразу после готовности, без анимации.
Balancy.RenderViewsManager.SetViewDelays(0f, 0f);
// По желанию клиента: сразу начать fade длительностью 150 мс.
Balancy.RenderViewsManager.SetViewDelays(0f, 0.15f);
```
